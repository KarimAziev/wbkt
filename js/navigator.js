...
(function () {
  ...
  var originalGlobalThis =
    typeof globalThis === 'undefined' ? void 0 : globalThis;

  // src/clipboard-polyfill/builtins/promise-constructor.ts
  var _a, _b, _c;
  var promiseConstructorImpl =
    (_c = (_a = originalWindow) == null ? void 0 : _a.Promise) != null
      ? _c
      : (_b = originalGlobalThis) == null
      ? void 0
      : _b.Promise;
  ...
  var _a2;
  ((_a2 = originalWindow) == null ? void 0 : _a2.Promise) ||
    setPromiseConstructor(PromisePolyfillConstructor);

  // src/clipboard-polyfill/builtins/builtin-globals.ts
  var originalNavigator = typeof navigator === 'undefined' ? void 0 : navigator;
  var originalNavigatorClipboard =
    originalNavigator == null ? void 0 : originalNavigator.clipboard;
  var _a3;
  var originalNavigatorClipboardRead =
    (_a3 =
      originalNavigatorClipboard == null
        ? void 0
        : originalNavigatorClipboard.read) == null
      ? void 0
      : _a3.bind(originalNavigatorClipboard);
  var _a4;
  var originalNavigatorClipboardReadText =
    (_a4 =
      originalNavigatorClipboard == null
        ? void 0
        : originalNavigatorClipboard.readText) == null
      ? void 0
      : _a4.bind(originalNavigatorClipboard);
  var _a5;
  var originalNavigatorClipboardWrite =
    (_a5 =
      originalNavigatorClipboard == null
        ? void 0
        : originalNavigatorClipboard.write) == null
      ? void 0
      : _a5.bind(originalNavigatorClipboard);
  var _a6;
  var originalNavigatorClipboardWriteText =
    (_a6 =
      originalNavigatorClipboard == null
        ? void 0
        : originalNavigatorClipboard.writeText) == null
      ? void 0
      : _a6.bind(originalNavigatorClipboard);
  var _a7;
  var originalWindowClipboardItem =
    (_a7 = originalWindow) == null ? void 0 : _a7.ClipboardItem;
  ...
  function ClipboardItemPolyfillImpl(items, options) {
    ...
    var presentationStyle =
      (_a8 = options == null ? void 0 : options.presentationStyle) != null
        ? _a8
        : 'unspecified';
  ...
  function seemToBeInIE() {
    return (
      ...
      typeof (ieWindow == null ? void 0 : ieWindow.clipboardData) !==
        'undefined' &&
      typeof (ieWindow == null ? void 0 : ieWindow.clipboardData.setData) !==
        'undefined'
    );
  }
    ...
    return rejectThrownErrors(function () {
      if (originalNavigatorClipboardWrite && originalWindowClipboardItem) {
        ...
        return promiseConstructor
          ...
          .then(function (globalClipboardItems) {
  ...
  window.clipboard = clipboardFallback;
  const navigatorFallback = {
  ...
  window.navigator = window.navigator || navigatorFallback;
  window.navigator.clipboard = window.navigator.clipboard || clipboardFallback;
  window.requestIdleCallback = (fn, opts) =>
    setTimeout(fn, (opts && opts.timeout) || 1000);
